...
def init_distributed():
    """
    Custom function to set environment up for distributed training. It initializes the process group.
...
def main():
    ...
    train_sampler = DistributedSampler(dataset=train_dataset, rank = dist.get_rank(), num_replicas=dist.get_world_size())
    ...
    eval_sampler = DistributedSampler(dataset=eval_dataset, rank=dist.get_rank(), num_replicas=dist.get_world_size())

...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="/s3/models/test4", help="Where to store the final model.")
...
def main():
    ...
    storage_path="s3://eks-ray-bucket/run_configs", name="train_images-ray"
    )

...
#     # Run the benchmark.
#     "python3 ray/release/air_tests/air_benchmarks/workloads/pytorch_training_e2e.py"
# )
...
def main(data_size_gb: int, num_epochs=2, num_workers=2, smoke_test: bool = False):
    data_url = (
    ...
    trainer = TorchTrainer(
        ...
        run_config=RunConfig(storage_path="/fsx/pytorch-resnet"),
    )
    trainer.fit()

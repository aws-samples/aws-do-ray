...
echo "Please wait until FSx Cluster is up and ready until you deploy Ray Cluster. Please check AWS Console or run 'kubectl get pvc -n kuberay' and wait until status is 'Bound'"
